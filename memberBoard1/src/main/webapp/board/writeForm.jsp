	...
	<div id="container">
		...
		<form action="./writeProcess.jsp" method="post" name="regForm">
				<table class="tbl_write">
					<tr>
						<td><input type="text" name="title" class="w_title" placeholder="글 제목" required="required" ></td>
					</tr>
					<tr>
						<td>
							<textarea rows="15" cols="50" name="content"  placeholder="글 내용" required="required"></textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2">
