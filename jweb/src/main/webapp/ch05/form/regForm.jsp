...
<title>회원 등록 폼</title>
<style >
	h2{background-color:green; color:#eee; text-align: center; paddig: 15px 0; border-radius:5px;}
	#regform{width:50%; margin:0 auto; background:lightgreen; padding: 15px 20px; border-radius:10px;}
</style>
